  ...
  <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
      ...
      <div class="bg-card rounded-2xl p-6 lg:p-8 border border-border">
        ...
        <div v-if="submitStatus === 'success'" class="mt-4 p-4 bg-green-500/20 text-green-500 rounded-lg text-sm">
      ...
      <div class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="text-muted-foreground text-sm">support@peakaudio.com</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="text-muted-foreground text-sm">123 Audio Street<br>Los Angeles, CA 90001</p>
              </div>
            </div>
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <p class="text-muted-foreground text-sm">Mon-Fri: 9:00 AM - 6:00 PM<br>Sat-Sun: 10:00 AM - 4:00 PM</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-card rounded-2xl p-6 lg:p-8 border border-border">
          ...
          <div class="flex gap-3">
            <button class="w-12 h-12 bg-primary/20 hover:bg-primary/30 rounded-lg flex items-center justify-center transition-colors">
