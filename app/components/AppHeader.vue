      ...
      <div class="flex items-center gap-4">
        ...
        <NuxtLink to="/" class="flex items-center gap-3 shrink-0" aria-label="Peak Audio Home">
          ...
          <div class="hidden sm:block">
            <span class="font-display text-xl font-bold text-foreground">PEAK AUDIO</span>
          </div>
        </NuxtLink>
        ...
        <div class="relative flex items-center gap-2 shrink-0" ref="moreRef">
          ...
          <div 
            v-if="showMore"
            class="absolute right-0 top-full mt-2 w-56 bg-card border border-border rounded-lg shadow-lg z-50 overflow-hidden"
          >
...
import { Headphones, Search, MoreHorizontal } from 'lucide-vue-next'
